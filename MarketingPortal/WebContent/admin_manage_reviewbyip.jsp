    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <!--  <div class="filter">
			 <form class="form-horizontal" role="form" method="post" action="admin_manage_reviewbyip.jsp" >
						  <div class="form-group">
						    ...
						    <div class="col-sm-2">
						      <input type="text" class="form-control" name="ip" id="ip"  placeholder="User Name" >
						    </div>
						     <div class="col-sm-2">
...
String sqlsearch = "select website.name as webname,reviews.ip_address as ip,products.name as productname,reviews.product_id,reviews.user_id,reviews.website_id,user.username ,count(*) as cnt from reviews,products,website,user where reviews.product_id=products.id && reviews.user_id=user.id && reviews.website_id=website.id && products.name like '%" +pname + "%' && website.name like '%" +web + "%' && user.username like '%" +ip + "%'  group by reviews.product_id,reviews.ip_address,reviews.website_id having cnt>1";

String sql = "select website.name as webname,reviews.ip_address as ip,products.name as productname,reviews.product_id,reviews.user_id,reviews.website_id,user.username,count(*) as cnt from reviews,products,website,user where reviews.product_id=products.id && reviews.user_id=user.id && reviews.website_id=website.id group by reviews.product_id,reviews.ip_address,reviews.website_id having cnt>1";

if(web==null && ip==null && pname==null)
{
	try {
		
		/*  Hash Algorith for Collision Attack */
