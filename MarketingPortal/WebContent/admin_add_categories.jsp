    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<!-- Add Category -->		
				 ...
				 <div class="category">
			 <form class="form-horizontal" role="form" method="post" action="/MarketingPortal/admin_save_category.jsp" onsubmit="return checkAddProduct(this)">
						  <div class="form-group">
						    <label class="control-label col-sm-2" for="email">Category Name:</label>
						    <div class="col-sm-10">
						      <input type="text" class="form-control" name="pname" id="pname" required="required" placeholder="Enter New Category" >
						    </div>
						  </div>
				...
				<div class="subcategory">
				  		<form class="form-horizontal" role="form" method="post" action="/MarketingPortal/admin_save_subcategory.jsp" onsubmit="return checkAddProduct(this)">
						  <div class="form-group">
				    ...
				    while (it.hasNext()) {
 				  	...
 				  	%>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control" name="subname" id="subname" required="required" placeholder="Enter New SubCategory">
						    </div>
						  </div>
				  	...
				  	<!-- Add Brands -->
				  	 ...
				  	 <div class="brand">
				  		<form class="form-horizontal" role="form" method="post" action="/MarketingPortal/admin_save_brand.jsp" onsubmit="return checkAddProduct(this)">
				    ...
				    while (itr.hasNext()) {
 				  	...
 				  	%>
						   ...
						   <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <select class="form-control" id="subcategories1" name="subcategories1">
						      <option value="">--Select--</option>
							  </select>
						    </div>
						  </div>
						  ...
						  <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      <input type="text" class="form-control" name="brandname" id="brandname" required="required" placeholder="Enter New Brand">
						    </div>
						  </div>
				  	 ...
				  	 <!-- Add OT -->
				  	   	 ...
				  	   	 <div class="ot">
				  		<form class="form-horizontal" role="form" method="post" action="/MarketingPortal/admin_save_ot.jsp" onsubmit="return checkAddProduct(this)">
						   ...
						   <div class="form-group">
						    ...
						    <div class="col-sm-10">
						      ...
						      <option value="">--Select--</option>
				  	<% 				  	
				  	Iterator itr2 = categories2.entrySet().iterator();
				    while (itr2.hasNext()) {
 				  	...
 				  	%>
						   ...
						   <div class="form-group">
						    <label class="control-label col-sm-2" for="email">Sub Category:</label>
						    <div class="col-sm-10">
						      <select class="form-control" id="subcategories2" name="subcategories2">
						      <option value="">--Select--</option>
							  </select>
						    </div>
						  </div>
						...
						<div class="form-group">
						    <label class="control-label col-sm-2" for="email">OT Name:</label>
						    <div class="col-sm-3">
						      <input type="text" class="form-control" name="ot" id="ot" required="required" placeholder="Enter New OT">
						    </div>
						  </div>  
						 <!--  <div class="form-group">
						    <label class="control-label col-sm-2" for="email">OT Name:</label>
						    <div class="col-sm-3">
						      <input type="text" class="form-control" name="ot2" id="ot2" required="required" placeholder="Enter New OT">
						    </div>
						  </div> 
						  <div class="form-group">
						    <label class="control-label col-sm-2" for="email">OT Name:</label>
						    <div class="col-sm-3">
						      <input type="text" class="form-control" name="ot3" id="ot3" required="required" placeholder="Enter New OT">
						    </div>
						  </div>  -->
