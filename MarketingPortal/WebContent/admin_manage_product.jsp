    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <select id="chng" onchange="window.location='admin_manage_product.jsp?website_id='+this.options[this.selectedIndex].value">
                <%
		       ...
		       out.println("<div class='price-number'>");
			    ...
			    out.println("</div>");
			       		out.println("<div class='add-cart'>");
							out.println("<h4><a href='admin_view_products.jsp?product_id="+rs.getString("id")+"'>Edit</a></h4>");							
					     out.println("</div>");
					     out.println("<div class='add-cart'>");
							out.println("<h4><a href='admin_delete_products.jsp?product_id="+rs.getString("id")+"'>Delete</a></h4>");							
					     out.println("</div>");
